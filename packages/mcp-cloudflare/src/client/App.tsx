        ...
        <article>
          ...
          <section className="space-y-4 mb-6">
            ...
            <Paragraph>
              ...
              data in the a local context to the LLM itself. This lets you take
              an agent that you already use, like Cursor, and pull in context
              from Sentry to help with tasks like debugging, code generation,
              and more.
            </Paragraph>
            <Paragraph>
              For an example, this showcases using Cursor to help with debugging
              an issue using Sentry's Seer functionality:
            </Paragraph>
            <iframe
              width="560"
              height="315"
            ...
            />
            <Note>
              <strong>Note:</strong> While this service is maintained by Sentry,
              it is very much still a proof-of-concept as the protocol is still
              in development (as is our own thinking around its usage).
            </Note>
          </section>
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <SetupGuide id="vscode" title="Visual Studio Code">
                ...
                <ol>
                  ...
                  <li>
                    Activate the server using <strong>MCP: List Servers</strong>{" "}
                    and selecting <strong>Sentry</strong>, and selecting{" "}
