/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ef09bc92dcdc02884df593cfad19180)
// Runtime types generated with workerd@1.20250424.0 2025-03-21 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/server/index").SentryMCP>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_CLIENT_ID" | "SENTRY_CLIENT_SECRET" | "COOKIE_SECRET">> {}
}
