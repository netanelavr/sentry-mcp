...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: [
      ...
      "",
      "This operation may take some time, so you should call `get_issue_fix_status()` to check the status of the analysis after you begin it.",
      "",
      "<examples>",
      "### Analyze and propose a fix for 'ISSUE-123' in Sentry",
      "",
      "```",
      "begin_issue_fix(organizationSlug='my-organization', issueId='ISSUE-123')",
      "```",
      "</examples>",
      "",
      "<hints>",
      "- Always check to see if an issue fix is already in progress for before calling this tool by using `get_issue_fix_status()`.",
      "- If the user provides the issueUrl, you can ignore the organizationSlug and issueId parameters.",
      "- If you're uncertain about which organization to query, you should call `list_organizations()` first. This especially important if an issueId is passed.",
      "</hints>",
    ].join("\n"),
  ...
  {
    name: "get_issue_fix_status" as const,
    description: [
      ...
      "",
      "```",
      "get_issue_fix_status(organizationSlug='my-organization', issueId='ISSUE-123')",
      "```",
      "",
      "</examples>",
      "",
